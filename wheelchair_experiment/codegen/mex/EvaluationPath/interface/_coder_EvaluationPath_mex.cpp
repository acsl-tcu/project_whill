...
void EvaluationPath_mexFunction(int32_T nlhs, mxArray *plhs[2], int32_T nrhs,
  const mxArray *prhs[4])
{
  ...
  // Call the function.
  EvaluationPath_api(prhs, nlhs, outputs);
                 ...
                 *prhs[])
{
  ...
  try {
    ...
    EvaluationPath_mexFunction(nlhs, plhs, nrhs, prhs);
...
// End of code generation (_coder_EvaluationPath_mex.cpp)
