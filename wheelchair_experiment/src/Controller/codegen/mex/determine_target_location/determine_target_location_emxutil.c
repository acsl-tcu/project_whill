 ...
 *
 * determine_target_location_emxutil.c
 *
 * Code generation for function 'determine_target_location_emxutil'
 *
 */
                       ...
                       const emlrtRTEInfo *srcLocation)
{
  ...
  *pEmxArray =
  ...
  emxArray->size = (int32_T *)emlrtMallocMex(sizeof(int32_T) * 4U);
...
/* End of code generation (determine_target_location_emxutil.c) */
