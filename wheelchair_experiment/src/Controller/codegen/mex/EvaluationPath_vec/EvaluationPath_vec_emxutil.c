 ...
 *
 * EvaluationPath_vec_emxutil.c
 *
 * Code generation for function 'EvaluationPath_vec_emxutil'
 *
 */
...
void emxFreeMatrix_cell_wrap_7(const emlrtStack *sp, cell_wrap_7 *pMatrix)
{
  emxFreeStruct_cell_wrap_7(sp, pMatrix);
}

void emxFreeStruct_cell_wrap_7(const emlrtStack *sp, cell_wrap_7 *pStruct)
{
  emxFree_boolean_T(sp, &pStruct->f1);
}
...
void emxInitMatrix_cell_wrap_7(const emlrtStack *sp, cell_wrap_7 *pMatrix,
                               const emlrtRTEInfo *srcLocation)
{
  emxInitStruct_cell_wrap_7(sp, pMatrix, srcLocation);
}

void emxInitStruct_cell_wrap_7(const emlrtStack *sp, cell_wrap_7 *pStruct,
                               const emlrtRTEInfo *srcLocation)
{
  emxInit_boolean_T(sp, &pStruct->f1, 2, srcLocation);
}
                             ...
                             const emlrtRTEInfo *srcLocation)
{
  ...
  pStruct->selectZone.size[0] = 0;
  pStruct->NoEntryZone.size[0] = 0;
  pStruct->NoEntryZone.size[1] = 0;
  pStruct->NoEntryZone.size[2] = 0;
  pStruct->ZoneNum.size[0] = 0;
  pStruct->V_ref.size[0] = 0;
  pStruct->th_target_w.size[0] = 0;
...
/* End of code generation (EvaluationPath_vec_emxutil.c) */
