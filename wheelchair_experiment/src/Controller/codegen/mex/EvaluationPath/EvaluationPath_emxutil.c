 ...
 *
 * EvaluationPath_emxutil.c
 *
 * Code generation for function 'EvaluationPath_emxutil'
 *
 */
                       ...
                       const emlrtRTEInfo *srcLocation)
{
  ...
  if (emxArray->allocatedSize < 30) {
    ...
    newData = emlrtMallocMex(30U * sizeof(real_T));
    if (newData == NULL) {
      emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
    }
    if (emxArray->data != NULL) {
    ...
    emxArray->data = (real_T *)newData;
    emxArray->allocatedSize = 30;
    emxArray->canFreeData = true;
  }
}

/* End of code generation (EvaluationPath_emxutil.c) */
