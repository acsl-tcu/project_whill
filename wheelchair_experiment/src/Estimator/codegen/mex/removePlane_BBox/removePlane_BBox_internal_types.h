 ...
 *
 * removePlane_BBox_internal_types.h
 *
...
/* Type Definitions */
#ifndef typedef_cuboidModel
#define typedef_cuboidModel
typedef struct {
  real_T Parameters[9];
} cuboidModel;
#endif /* typedef_cuboidModel */
...
/* End of code generation (removePlane_BBox_internal_types.h) */
