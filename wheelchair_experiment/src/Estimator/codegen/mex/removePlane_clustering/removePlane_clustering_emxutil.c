 ...
 *
 * removePlane_clustering_emxutil.c
 *
 * Code generation for function 'removePlane_clustering_emxutil'
 *
 */
...
void emxFreeStruct_pointCloud(const emlrtStack *sp, pointCloud *pStruct)
{
  ...
  emxFree_real_T(sp, &pStruct->RangeData);
...
void emxInitStruct_pointCloud(const emlrtStack *sp, pointCloud *pStruct,
                              const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->Location, 3, srcLocation);
  emxInit_uint8_T(sp, &pStruct->Color, 3, srcLocation);
  emxInit_real_T(sp, &pStruct->Normal, 3, srcLocation);
  emxInit_real_T(sp, &pStruct->Intensity, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->RangeData, 3, srcLocation);
  c_emxInit_pointclouds_internal_(sp, &pStruct->PointCloudArrayData,
                                  srcLocation);
}

void emxInitStruct_pointCloud1(const emlrtStack *sp, pointCloud *pStruct,
                               const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_real_T(sp, &pStruct->Intensity, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->RangeData, 2, srcLocation);
  c_emxInit_pointclouds_internal_(sp, &pStruct->PointCloudArrayData,
                                  srcLocation);
}
...
/* End of code generation (removePlane_clustering_emxutil.c) */
