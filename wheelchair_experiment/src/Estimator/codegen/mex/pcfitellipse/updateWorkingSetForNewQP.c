...
void b_updateWorkingSetForNewQP(const emlrtStack *sp, const real_T xk[5],
                                k_struct_T *WorkingSet, const real_T cIneq[2],
                                ...
                                const real_T ub[5], int32_T mFixed)
{
  ...
  for (idx = 0; idx < i; idx++) {
    if (idx + 1 > 8) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, 8, &xe_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  if (WorkingSet->nActiveConstr > mFixed) {
    ...
    for (idx = ineqStart; idx <= b; idx++) {
      if (idx > 15) {
        emlrtDynamicBoundsCheckR2012b(idx, 1, 15, &ye_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      ...
      case 4:
        ...
        if ((i < 1) || (i > 8)) {
          emlrtDynamicBoundsCheckR2012b(i, 1, 8, &xe_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
