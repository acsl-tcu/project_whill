                         ...
                         int32_T iL0)
{
  ...
  for (idx = 0; idx < i; idx++) {
    if (idx + 1 > 8) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, 8, &p_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    i1 = finiteLB[idx];
    if ((i1 < 1) || (i1 > 5)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, 5, &q_emlrtBCI, (emlrtConstCTX)sp);
    }
    lbDelta = xCurrent[i1 - 1] - lb[i1 - 1];
    i1 = (iL0 + idx) + 2;
    if ((i1 < 1) || (i1 > 15)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, 15, &r_emlrtBCI, (emlrtConstCTX)sp);
    }
