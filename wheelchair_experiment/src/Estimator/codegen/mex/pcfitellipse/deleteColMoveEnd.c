...
void deleteColMoveEnd(const emlrtStack *sp, g_struct_T *obj, int32_T idx)
{
  ...
  if (obj->usedPivoting) {
    ...
    while ((!exitg1) && (i <= obj->ncols)) {
      if (i > 15) {
        emlrtDynamicBoundsCheckR2012b(16, 1, 15, &fd_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      if (obj->jpvt[i - 1] != idx) {
        i++;
  ...
  if (idx >= obj->ncols) {
    ...
    if ((obj->ncols < 1) || (obj->ncols > 15)) {
      emlrtDynamicBoundsCheckR2012b(obj->ncols, 1, 15, &fd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if ((idx < 1) || (idx > 15)) {
      emlrtDynamicBoundsCheckR2012b(idx, 1, 15, &gd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    b_i = obj->ncols - 1;
    ...
    for (k = 0; k < i; k++) {
      n = (k + 15 * b_i) + 1;
      if ((n < 1) || (n > 225)) {
        emlrtDynamicBoundsCheckR2012b(n, 1, 225, &hd_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      QRk0 = (k + 15 * (idx - 1)) + 1;
      if ((QRk0 < 1) || (QRk0 > 225)) {
        emlrtDynamicBoundsCheckR2012b(QRk0, 1, 225, &id_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
    ...
    if (idx < obj->mrows) {
      ...
      while (k >= idx) {
        ...
        b_i = k + i;
        if ((b_i < 1) || (b_i > 225)) {
          emlrtDynamicBoundsCheckR2012b(b_i, 1, 225, &hd_emlrtBCI, &st);
        }
        temp_tmp = obj->QR[b_i - 1];
        if ((b_i + 1 < 1) || (b_i + 1 > 225)) {
          emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, 225, &hd_emlrtBCI, &st);
        }
        temp = obj->QR[b_i];
        ...
        n = (k + b_i) + 1;
        if ((n < 1) || (n > 225)) {
          emlrtDynamicBoundsCheckR2012b(n, 1, 225, &id_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        obj->QR[n - 1] = 0.0;
        QRk0 = k + 15 * idx;
      ...
      for (k = b_i; k <= endIdx; k++) {
        ...
        n = k + i;
        if ((n < 1) || (n > 225)) {
          emlrtDynamicBoundsCheckR2012b(n, 1, 225, &hd_emlrtBCI, &st);
        }
        temp_tmp = obj->QR[n - 1];
        if ((n + 1 < 1) || (n + 1 > 225)) {
          emlrtDynamicBoundsCheckR2012b(n + 1, 1, 225, &hd_emlrtBCI, &st);
        }
        temp = obj->QR[n];
        b_st.site = &ig_emlrtRSI;
        c = 0.0;
