    ...
    boolean_T *newBlocking, int32_T *constrType, int32_T *constrIdx)
{
  ...
  *constrIdx = 0;
  ...
  if (workingset_nWConstr[2] < 2) {
    ...
    st.site = &mh_emlrtRSI;
    b_xgemv(&st, workingset_nVar, workingset_Aineq, solution_xstar, workspace);
    st.site = &mh_emlrtRSI;
    ...
    for (iac = 0; iac < 2; iac++) {
      ...
      if (phaseOneCorrectionX > denomTol) {
        ...
        if ((i < 1) || (i > 15)) {
          emlrtDynamicBoundsCheckR2012b(i, 1, 15, &mb_emlrtBCI, &st);
        }
  ...
  if (workingset_nWConstr[3] < workingset_sizes[3]) {
    ...
    for (iac = 0; iac <= i - 2; iac++) {
      if ((iac + 1 < 1) || (iac + 1 > 8)) {
        emlrtDynamicBoundsCheckR2012b(iac + 1, 1, 8, &gf_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      b = workingset_indexLB[iac];
      if ((b < 1) || (b > 8)) {
        emlrtDynamicBoundsCheckR2012b(b, 1, 8, &gf_emlrtBCI, (emlrtConstCTX)sp);
      }
      ...
      if (c > denomTol) {
        ...
        if ((ia < 1) || (ia > 15)) {
          emlrtDynamicBoundsCheckR2012b(ia, 1, 15, &mb_emlrtBCI, &st);
        }
    ...
    if ((workingset_sizes[3] < 1) || (workingset_sizes[3] > 8)) {
      emlrtDynamicBoundsCheckR2012b(workingset_sizes[3], 1, 8, &gf_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    i = workingset_indexLB[workingset_sizes[3] - 1];
    if ((i < 1) || (i > 8)) {
      emlrtDynamicBoundsCheckR2012b(i, 1, 8, &gf_emlrtBCI, (emlrtConstCTX)sp);
    }
    ...
    if (phaseOneCorrectionX > denomTol) {
      ...
      if ((b - 1 < 1) || (b - 1 > 15)) {
        emlrtDynamicBoundsCheckR2012b(b - 1, 1, 15, &mb_emlrtBCI, &st);
      }
