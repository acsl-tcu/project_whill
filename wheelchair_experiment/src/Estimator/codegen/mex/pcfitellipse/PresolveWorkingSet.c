                        ...
                        g_struct_T *qrmanager)
{
  ...
  if (mTotalWorkingEq_tmp_tmp > 0) {
    ...
    for (idxDiag = 0; idxDiag < mTotalWorkingEq_tmp_tmp; idxDiag++) {
      ...
      for (idx_col = 0; idx_col < i; idx_col++) {
        totalRank_tmp = (idx_col + (idxDiag << 3)) + 1;
        if ((totalRank_tmp < 1) || (totalRank_tmp > 120)) {
          emlrtDynamicBoundsCheckR2012b(totalRank_tmp, 1, 120, &xb_emlrtBCI,
                                        &st);
        }
        k = (idxDiag + 15 * idx_col) + 1;
        if ((k < 1) || (k > 225)) {
          emlrtDynamicBoundsCheckR2012b(k, 1, 225, &yb_emlrtBCI, &st);
        }
    ...
    idxDiag = totalRank_tmp + 15 * (totalRank_tmp - 1);
    while ((idxDiag > 0) &&
    ...
    if (nDepInd > 0) {
      ...
      while ((!exitg1) && (idx_col <= nDepInd - 1)) {
        real_T qtb;
        idxDiag = 15 * ((mTotalWorkingEq_tmp_tmp - idx_col) - 1);
        c_st.site = &we_emlrtRSI;
        qtb = 0.0;
    ...
    if (nDepInd > 0) {
      ...
      for (idx_col = 0; idx_col < mTotalWorkingEq_tmp_tmp; idx_col++) {
        b_st.site = &ve_emlrtRSI;
        b_xcopy(&b_st, nVar, workingset->ATwset, (idx_col << 3) + 1,
      ...
      for (idx_col = 0; idx_col < mWorkingFixed; idx_col++) {
        if ((idx_col + 1 < 1) || (idx_col + 1 > 15)) {
          emlrtDynamicBoundsCheckR2012b(idx_col + 1, 1, 15, &vb_emlrtBCI,
                                        &b_st);
        }
      ...
      for (idx_col = idxDiag; idx_col <= mTotalWorkingEq_tmp_tmp; idx_col++) {
        if ((idx_col < 1) || (idx_col > 15)) {
          emlrtDynamicBoundsCheckR2012b(idx_col, 1, 15, &vb_emlrtBCI, &b_st);
        }
      ...
      for (idx_col = 0; idx_col < nDepInd; idx_col++) {
        ...
        if ((i < 1) || (i > 15)) {
          emlrtDynamicBoundsCheckR2012b(i, 1, 15, &ac_emlrtBCI, &b_st);
        }
        if (idx_col + 1 > 15) {
          emlrtDynamicBoundsCheckR2012b(idx_col + 1, 1, 15, &vb_emlrtBCI,
                                        &b_st);
      ...
      for (idx_col = nDepInd; idx_col >= 1; idx_col--) {
        b_st.site = &ve_emlrtRSI;
        if (idx_col > 15) {
          emlrtDynamicBoundsCheckR2012b(idx_col, 1, 15, &ub_emlrtBCI, &b_st);
        }
        ...
        if (i != 0) {
          ...
          if (totalRank_tmp <= i) {
            if ((workingset->nActiveConstr == i) || (totalRank_tmp == i)) {
              ...
              if ((totalRank_tmp < 1) || (totalRank_tmp > 15)) {
                emlrtDynamicBoundsCheckR2012b(totalRank_tmp, 1, 15,
                                              &bc_emlrtBCI, &b_st);
              }
              ...
              if ((idxDiag < 1) || (idxDiag > 6)) {
                emlrtDynamicBoundsCheckR2012b(idxDiag, 1, 6, &nb_emlrtBCI,
                                              &c_st);
              }
              i = (workingset
                  ...
                  1;
              if ((i < 1) || (i > 15)) {
                emlrtDynamicBoundsCheckR2012b(i, 1, 15, &rb_emlrtBCI, &c_st);
              }
              workingset->isActiveConstr[i - 1] = false;
              if (totalRank_tmp < workingset->nActiveConstr) {
              ...
              if ((idxDiag < 1) || (idxDiag > 5)) {
                emlrtDynamicBoundsCheckR2012b(idxDiag, 1, 5, &tb_emlrtBCI,
                                              &c_st);
              }
              ...
              if ((idxDiag < 1) || (idxDiag > 6)) {
                emlrtDynamicBoundsCheckR2012b(idxDiag, 1, 6, &wb_emlrtBCI,
                                              &b_st);
              }
              k = (workingset->isActiveIdx[idxDiag - 1] +
                  ...
                  1;
              if ((k < 1) || (k > 15)) {
                emlrtDynamicBoundsCheckR2012b(k, 1, 15, &dc_emlrtBCI, &b_st);
              }
              ...
              workingset->nActiveConstr--;
              if ((idxDiag < 1) || (idxDiag > 5)) {
                emlrtDynamicBoundsCheckR2012b(idxDiag, 1, 5, &ec_emlrtBCI,
                                              &b_st);
              }
              workingset->nWConstr[idxDiag - 1]--;
            }
  ...
  if ((nDepInd != -1) && (workingset->nActiveConstr <= 15)) {
    boolean_T guard1;
    st.site = &ue_emlrtRSI;
