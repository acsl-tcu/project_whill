  ...
  if (mNull_tmp <= 0) {
    ...
    for (A_maxDiag_idx = 0; A_maxDiag_idx <= nVar; A_maxDiag_idx++) {
      if ((A_maxDiag_idx + 1 < 1) || (A_maxDiag_idx + 1 > 8)) {
        emlrtDynamicBoundsCheckR2012b(A_maxDiag_idx + 1, 1, 8, &de_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
    ...
    if (qrmanager->ncols <= 0) {
      ...
      if (objective->objtype == 5) {
        ...
        for (A_maxDiag_idx = 0; A_maxDiag_idx < mNull_tmp; A_maxDiag_idx++) {
          ...
          if ((k < 1) || (k > 225)) {
            emlrtDynamicBoundsCheckR2012b(k, 1, 225, &fe_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          ...
          memspace->workspace_float[A_maxDiag_idx] = -qrmanager->Q[k - 1];
        }
        st.site = &li_emlrtRSI;
        ...
        if (objective->objtype == 3) {
          ...
          for (idx_col = 0; idx_col < mNull_tmp; idx_col++) {
            ...
            for (idx_row = A_maxDiag_idx; idx_row <= vectorUB; idx_row += 2) {
              ...
              if ((k < 1) || (k > 15)) {
                emlrtDynamicBoundsCheckR2012b(k, 1, 15, &he_emlrtBCI, &st);
              }
              r = _mm_loadu_pd(&qrmanager->Q[(idx_row + 15 * (k - 1)) - 1]);
              if ((idx_row < 1) || (idx_row > 15)) {
                emlrtDynamicBoundsCheckR2012b(idx_row, 1, 15, &ie_emlrtBCI,
                                              &st);
              }
              if (idx_col + 1 > 8) {
                emlrtDynamicBoundsCheckR2012b(idx_col + 1, 1, 8, &je_emlrtBCI,
                                              &st);
              }
              _mm_storeu_pd(
                  &memspace->workspace_float[(idx_row + 15 * idx_col) - 1],
        ...
        if (alwaysPositiveDef) {
          ...
          if ((k + 1 < 1) || (k + 1 > 225)) {
            emlrtDynamicBoundsCheckR2012b(k + 1, 1, 225, &ee_emlrtBCI, &b_st);
          }
          c_st.site = &pi_emlrtRSI;
          ...
          if (cholmanager->ConvexCheck) {
            ...
            do {
              ...
              if (A_maxDiag_idx <= mNull_tmp - 1) {
                ...
                if ((k < 1) || (k > 225)) {
                  emlrtDynamicBoundsCheckR2012b(k, 1, 225, &ee_emlrtBCI, &b_st);
                }
          ...
          if (alwaysPositiveDef) {
            ...
            if (cholmanager->ndims != 0) {
              ...
              for (scalarLB = 0; scalarLB < A_maxDiag_idx; scalarLB++) {
                nVars = scalarLB * 15;
                c = memspace->workspace_float[scalarLB];
                ...
                memspace->workspace_float[scalarLB] =
            ...
            b_st.site = &ij_emlrtRSI;
            c_solve(&b_st, cholmanager, memspace->workspace_float);
          }
          st.site = &li_emlrtRSI;
          g_xgemv(&st, qrmanager->mrows, mNull_tmp, qrmanager->Q,
                  nullStartIdx_tmp, memspace->workspace_float,
