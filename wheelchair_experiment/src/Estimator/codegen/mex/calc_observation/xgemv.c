...
void b_xgemv(const emlrtStack *sp, int32_T m, int32_T n, const real_T A[120],
...
void c_xgemv(const emlrtStack *sp, int32_T m, const real_T A[16],
             const real_T x[120], real_T y[15])
{
  __m128d r;
  emlrtStack b_st;
  emlrtStack c_st;
...
void d_xgemv(const emlrtStack *sp, int32_T m, const real_T A[16],
             const real_T x[120], real_T y[15])
{
  __m128d r;
  emlrtStack b_st;
...
void e_xgemv(const emlrtStack *sp, int32_T m, const real_T A[16],
             const real_T x[8], real_T y[15])
{
  __m128d r;
  emlrtStack b_st;
  emlrtStack c_st;
...
void f_xgemv(const emlrtStack *sp, int32_T m, const real_T A[16],
             const real_T x[8], real_T y[120])
{
  emlrtStack b_st;
  emlrtStack c_st;
...
void g_xgemv(const emlrtStack *sp, int32_T m, int32_T n, const real_T A[225],
