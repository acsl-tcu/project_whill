                       ...
                       real_T bineq, const real_T lb[5], const real_T ub[5])
{
  ...
  if (!y) {
    emlrtErrorWithMessageIdR2018a(
        sp, &p_emlrtRTEI, "optimlib_codegen:common:InfNaNComplexDetected",
  ...
  if (guard1) {
    emlrtErrorWithMessageIdR2018a(
        &st, &q_emlrtRTEI, "optimlib_codegen:common:InfNaNComplexDetectedLB",
  ...
  if (guard1) {
    emlrtErrorWithMessageIdR2018a(
        &st, &q_emlrtRTEI, "optimlib_codegen:common:InfNaNComplexDetectedUB",
