...
static emlrtRSInfo xkb_emlrtRSI = { 12,// lineNo
  "atan2",                             // fcnName
...
namespace coder
{
  void b_atan2(const emlrtStack *sp, const ::coder::array<real_T, 1U> &y, const ::
               coder::array<real_T, 1U> &x, ::coder::array<real_T, 1U> &r)
  {
    array<real_T, 1U> z;
    emlrtStack b_st;
    emlrtStack c_st;
